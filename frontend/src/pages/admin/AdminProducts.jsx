...
// const WOMENS_DRESS = "Women's Dress";
...
export default function AdminProducts() {
  ...
  return (
    <section>
      ...
      {/* Search + Filter */}
      <div className="mb-4 flex flex-col gap-3 rounded-[2rem] border border-blue-100 bg-white p-4 shadow-xl shadow-blue-950/5 md:flex-row md:items-center md:justify-between">
      ...
      {/* Product Grid - small cards 4 cols */}
      <div className="grid grid-cols-2 gap-3 md:grid-cols-3 xl:grid-cols-4">
        {filtered.map((product) => (
          <div key={product._id} className="overflow-hidden rounded-2xl border border-blue-100 bg-white shadow-md shadow-blue-950/5 transition hover:shadow-lg">
            <div className="relative">
